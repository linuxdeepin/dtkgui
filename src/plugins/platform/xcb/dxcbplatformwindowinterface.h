...
public:
    ...
    bool setWindowBlurAreaByWM(const QVector<DPlatformHandle::WMBlurArea> &area) override;
    bool setWindowBlurAreaByWM(const QList<QPainterPath> &paths) override;

    void setDisableWindowOverrideCursor(bool disable);
