...
public:
    ...
    virtual bool setWindowBlurAreaByWM(const QVector<DPlatformHandle::WMBlurArea> &area);
    virtual bool setWindowBlurAreaByWM(const QList<QPainterPath> &paths);
