...
- Mark DImageHandler as deprecated

## [6.7.49] - 2026-09-10

### Changed

- Release single instance lock on aboutToQuit

### Fixed

- Install DLL to bin directory on Windows
- Use QImage::flipped() for Qt6 compatibility
...
- Add Windows/MSYS2 build compatibility
...
- Remove Q_OS_LINUX guard from DSvgRenderer to enable Windows build

## [6.7.46] - 2026-07-16

### Fixed

- Fix decorator loss when setting clipboard windows visible
- Prevent theme from being saved incorrectly in some applications

## [6.7.45] - 2026-07-09

### Added

- Add border and shadow support for TreeLand windows
- Add window effect support for treeland platform

### Fixed

- Align MoveWindowHelper with xcb
- Prevent window blur loss on destruction in treeland platform
- Prevent pending state failure in window platform interface

## [6.7.44] - 2026-06-17

### Fixed

- Adapt to treeland wallpaper protocol changes
...
- Add window radius control for treeland platform
- Support system window menu on treeland/wayland
- Add GitHub Actions CI workflows for Arch Linux and Deepin builds
- Add HasInWindowBlur attribute to DGuiApplicationHelper
...
- Forward XDG_ACTIVATION_TOKEN to single-instance server
- New release 6.7.42 (#382)
...
- Use active color as fallback for dark active color in treeland
